...
//               <strong className={styles.highlight}>React.js, Next.js, and React Native</strong>. 
//               I specialize in building responsive web applications and cross-platform mobile apps 
//               that deliver exceptional user experiences. Experienced in generating{" "}
...
//                 </div>
//               </a>
//               <a href="https://github.com/Saurabh63948" target="_blank" rel="noopener noreferrer" className={styles.contactCard}>
//                 <span className={styles.contactIcon}>💻</span>
//                 <div>
...
//                 </div>
//               </a>
//               <a href="https://linkedin.com/in/singh-saurabh07" target="_blank" rel="noopener noreferrer" className={styles.contactCard}>
//                 <span className={styles.contactIcon}>💼</span>
//                 <div>
...
//           <p>© 2024 Saurabh Singh. Built with passion and React.</p>
//         </footer>
//       </div>
//     </div>
//   );
